        ...
        {" a{ color: green}"}
            ...
            <div id="navbarBasicExample" className="navbar-menu">
                ...
                <div className="navbar-item">
                    <Link href="/proyek/Galeriproduk"><a className="navbar-item"><i className=" fas fa-camera fa-fw"></i>-Galeri Produk</a></Link>
                <div className="navbar-item-dropdown"></div>
                    <Link href="/proyek/pemesanan"><a className="navbar-item"><i className="fas fa-shopping-cart fa-fw"></i>Pemesanan</a></Link>
                    </div>
                    </div>
                    </div>
                    </nav>
